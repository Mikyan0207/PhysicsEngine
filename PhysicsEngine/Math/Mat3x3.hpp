...
class [[nodiscard]] alignas(PE_VECTOR4_ALIGNMENT) Mat3x3
{
  public:
    ...
    PE_INLINE Mat3x3 operator*(Mat3x3 rhs) const;
    PE_INLINE Mat3x3 operator+(Mat3x3 rhs) const;
    PE_INLINE Mat3x3 operator-(Mat3x3 rhs) const;

    PE_INLINE Mat3x3 operator*(float s) const;
    PE_INLINE Mat3x3 operator+(float s) const;
    PE_INLINE Mat3x3 operator-(float s) const;

    PE_INLINE Mat3x3& operator*=(Mat3x3 rhs);
    PE_INLINE Mat3x3& operator+=(Mat3x3 rhs);
    PE_INLINE Mat3x3& operator-=(Mat3x3 rhs);

    PE_INLINE Mat3x3& operator*=(float s);
    PE_INLINE Mat3x3& operator+=(float s);
    PE_INLINE Mat3x3& operator-=(float s);
...
#include <PhysicsEngine/Math/Mat3x3.inl>
