...
PE_INLINE Mat4x4::Mat4x4(Vector4 c1, Vector4 c2, Vector4 c3, Vector4 c4)
{
    m_Cols[0] = c1;
    m_Cols[1] = c2;
    m_Cols[2] = c3;
...
PE_INLINE Mat4x4 Mat4x4::Identity()
{
    return Mat4x4(Vector4(1, 0, 0, 0), Vector4(0, 1, 0, 0), Vector4(0, 0, 1, 0), Vector4(0, 0, 0, 1));
}
...
Mat4x4 Mat4x4::operator*(Mat4x4 rhs) const
{
    ...
    for (int i = 0; i < 4; ++i)
    {
        result.m_Cols[i] = m_Cols[0] * rhs.m_Cols[i].m_Value32[0] + m_Cols[1] * rhs.m_Cols[i].m_Value32[1] +
                           m_Cols[2] * rhs.m_Cols[i].m_Value32[2] + m_Cols[3] * rhs.m_Cols[i].m_Value32[3];
    }
...
float Mat4x4::Determinant() const
{
    ...
    Vector4 const detCof(+(M(1, 1) * subFactor00 - M(1, 2) * subFactor01 + M(1, 3) * subFactor02),
...
Mat4x4 Mat4x4::Cofactor() const
{
    ...
    return Mat4x4(Vector4(+M(1, 1) * m22_33_23_32 - M(1, 2) * m21_33_23_31 + M(1, 3) * m21_32_22_31,
                  ...
                  Vector4(-M(0, 1) * m22_33_23_32 + M(0, 2) * m21_33_23_31 - M(0, 3) * m21_32_22_31,
                  ...
                  Vector4(+M(0, 1) * m12_33_13_32 - M(0, 2) * m11_33_13_31 + M(0, 3) * m11_32_12_31,
                  ...
                  Vector4(-M(0, 1) * m12_23_13_22 + M(0, 2) * m11_23_13_21 - M(0, 3) * m11_22_12_21,
