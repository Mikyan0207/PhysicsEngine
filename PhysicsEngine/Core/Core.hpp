...
#define PE_SUPPRESS_WARNINGS_STD_BEGIN                                                                                 \
    PE_SUPPRESS_WARNING_PUSH                                                                                           \
    PE_MSVC_SUPPRESS_WARNING(4619)                                                                                     \
    PE_MSVC_SUPPRESS_WARNING(4710)                                                                                     \
    PE_MSVC_SUPPRESS_WARNING(4711)                                                                                     \
    PE_MSVC_SUPPRESS_WARNING(4820)                                                                                     \
    PE_MSVC_SUPPRESS_WARNING(4514)                                                                                     \
    PE_MSVC_SUPPRESS_WARNING(5262)                                                                                     \
    PE_MSVC_SUPPRESS_WARNING(5264)                                                                                     \
                                                                                                                       \
    PE_GCC_SUPPRESS_WARNING("-Wstringop-overflow=")

#define PE_SUPPRESS_WARNINGS_STD_END PE_SUPPRESS_WARNING_POP
